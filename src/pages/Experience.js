...
import boy2Image from './img/IMG_20240708_135420_516.jpg';
import boy1Image from './img/IMG_20240708_135420_804.jpg';
import boy3Image from './img/IMG_20240708_135421_121.jpg';
import jov2Image from './img/a0136fb7-a4c1-4b9a-a1e8-1ae4aefcda0f.jpg';
import pictureImage from './img/341046843_1260195034913568_2895044067018550442_n.jpg';
import picture1Image from './img/330288575_1609010619618774_2737768018781094661_n.jpg';
import certificateImage from './img/IMG_20240708_135421_334.jpg';
        ...
        <div className="container mt-5 bg-dark">
          ...
          <div className="row mt-5 justify-content-center">
            ...
            <div className="col portfolio-item d-flex flex-column align-items-center">
              ...
              <h4 className="mt-5 text-white">Printing</h4>
            </div>
            <div className="col portfolio-item d-flex flex-column align-items-center">
          ...
          <div className="row mt-5 justify-content-center">
            ...
            <div className="col portfolio-item d-flex flex-column align-items-center">
              ...
              <h4 className="mt-5 text-white">Thesis Development</h4>
            </div>
            <div className="col portfolio-item d-flex flex-column align-items-center">
              <img className="three" src={picture1Image} alt="Meeting" />
              <h4 className="mt-5 text-white">Meeting</h4>
            </div>
          </div>
